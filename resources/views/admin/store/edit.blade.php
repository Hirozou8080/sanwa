          ...
          {{Form::open(['url' => route('admin/store/edit',$store->id) , 'files' => true])}}
            <div class="form-item">
              ...
              <div class="form-content">
                {{Form::text('storeName', $store->name, ['class' => 'form-control', 'id' => 'storeName', 'placeholder' => 'マリンピア店'])}}
              </div>
            </div>
            <div class="form-item">
              <div class="form-title">
              ...
              <div class=" flex-items">
                <div class="form-content">
                  {{Form::text('postNumPrev', $store->postNumPrev, ['class' => 'form-control', 'id' => 'postNumPrev', 'placeholder' => '123'])}}
                </div>
                ー
                <div class="form-content">
                  {{Form::text('postNumNext', $store->postNumNext, ['class' => 'form-control', 'id' => 'postNumNext', 'placeholder' => '4567'])}}
                </div>
              </div>
            </div>
            <div class="form-item">
              ...
              <div class="form-content">
                <select name="prefecture" id="prefecture">
                  @foreach ($prefectures as $prefecture)
                    <option class="form-control" value="{{$prefecture['id']}}" {{$prefecture['id']==$store->prefecture_id ? 'selected':''}}>{{$prefecture['name']}}</option>
                  @endforeach
              </select>
              </div>
            </div>
            <div class="form-item">
              ...
              <div class="form-item">
                ...
                <div class="form-content">
                  {{Form::text('address', $store->address, ['class' => 'form-control', 'id' => 'address', 'placeholder' => '栄町1-1-1'])}}
                </div>
              </div>
              <div class="form-item">
                <div class="form-title">
                ...
                <div class=" flex-items" style="justify-content:center; gap:50px ; border:1px solid #ccc;border-radius:5px; padding:.5rem">
                  ...
                  <div class="form-content">
                    <div class="flex-items">
                      ...
                      {{Form::radio('recruit', 2, $store->recruit_flg == 2 ? true : false , ['id'=>'noRecruit','class'=>'circle'])}}
                    </div>
                  </div>
                </div>
              </div>
