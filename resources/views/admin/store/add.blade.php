      ...
      <div class="form-block">
        ...
        <div class="form-item">
          ...
          <div class="form-content">
            {{ Form::text('storeName', null, ['class' => 'form-control', 'id' => 'storeName', 'placeholder' =>
            'マリンピア店']) }}
          </div>
        </div>
        <div class="form-item">
          ...
          <div class=" flex-items">
            <div class="form-content">
              {{ Form::text('postNumPrev', null, ['class' => 'form-control', 'id' => 'postNumPrev', 'placeholder' =>
              '123']) }}
            </div>
            ー
            <div class="form-content">
              {{ Form::text('postNumNext', null, ['class' => 'form-control', 'id' => 'postNumNext', 'placeholder' =>
              '4567']) }}
            </div>
          </div>
        </div>
